// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WindowStyles.cs" company="Solidsoft Reply Ltd.">
...
public enum WindowStyles : uint
{
    ...
    /// <summary>  
    /// <p>Clips child windows relative to each other; that is, when a particular
    ...
    /// child window to be updated.</p>
    /// <p>If WS_CLIPSIBLINGS is not specified and child windows overlap, it is
    /// possible, when drawing within the client area of a child window, to
    /// draw within the client area of a neighboring child window.</p>
    /// </summary>  
    ...
    /// <summary>  
    /// <p>The window is the first control of a group of controls. The group
    /// consists of this first control and all controls defined after it,
    /// up to the next control with the WS_GROUP style.</p>
    /// <p>The first control in each group usually has the WS_TABSTOP style
    /// so that the user can move from group to group. The user can
    /// subsequently change the keyboard focus from one control in the
    /// group to the next control in the group by using the direction keys.</p>
    /// <p>You can turn this style on and off to change dialog box navigation.
    /// To change this style after a window has been created, use the
    /// SetWindowLong function.</p>
    /// </summary>  
    WS_GROUP = 0x20000,
    ...
    /// <summary>The window is an overlapped window. An overlapped window has
    /// a title bar and a border.</summary>  
    WS_OVERLAPPED = 0x0,

    /// <summary>The window is an overlapped window.</summary>  
    WS_OVERLAPPEDWINDOW = WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_SIZEFRAME | WS_MINIMIZEBOX | WS_MAXIMIZEBOX,

    /// <summary>The window is a pop-up window. This style cannot be used with
    ...
    /// <summary>The window is initially visible. This style can be turned on and
    /// off by using the ShowWindow or SetWindowPos function.</summary>  
