// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WindowStylesEx.cs" company="Solidsoft Reply Ltd.">
...
public enum WindowStylesEx : uint
{
    ...
    /// order using double-buffering. For more information, see Remarks. This
    ...
    /// <summary>  
    /// <p>Includes a question mark in the title bar of the window. When the user
    ...
    /// typically contains help for the child window.</p>
    /// <p>WS_EX_CONTEXTHELP cannot be used with the WS_MAXIMIZEBOX or
    /// WS_MINIMIZEBOX styles.</p>
    /// </summary>  
    ...
    /// <summary>  
    /// Arabic and Hebrew versions of Windows 98/Me, Windows 2000/XP: Creates a
    /// window whose horizontal origin is on the right edge. Increasing horizontal
    ...
    /// become the foreground window when the user clicks it. The system does
    /// not bring this window to the foreground when the user minimizes or
    ...
    /// <summary>  
    /// Windows 2000/XP: A window created with this style does not pass its
    /// window layout to its child windows.  
    /// </summary>  
    ...
    /// <summary>  
    /// <p>The window has generic "right-aligned" properties. This depends on the
    ...
    /// otherwise, the style is ignored.</p>
    /// <p>Using the WS_EX_RIGHT style for static or edit controls has the same
    ...
    /// not appear in the taskbar or in the dialog that appears when the user
    /// presses ALT+TAB. If a tool window has a system menu, its icon is not
    /// displayed on the title bar. However, you can display the system menu by
    ...
    /// <summary>  
    /// <p>Specifies that a window created with this style should not be painted until
    ...
    /// windows have already been painted.</p>
    /// <p>To achieve transparency without these restrictions, use the SetWindowRgn
    /// function.</p>
    /// </summary>  
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "Reviewed. Suppression is OK here.")]
